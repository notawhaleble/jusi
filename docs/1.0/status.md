...
- `JusiCloseClient` now uses the exact client identity when invoked from a terminal projection and cell-based selection when invoked from notebook text. Incident 0005 prevents terminal screen rows from being mistaken for notebook coordinates.
