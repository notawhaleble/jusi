...
- Work is paused before bundled `%%vd` implementation or production plugin migration. Two personal development skill drafts now describe the implemented channel and are ready for review: `jusi-plugin-development` and `jusi-plugin-family-development`. The next plugin implementation should use the agreed skills.
...
- The foundation review is accepted; ADRs 0001-0016 and 0018-0036 are active. ADR 0017 and all web-surface implementation are explicitly deferred while the product direction—including web-as-text—is still exploratory.
