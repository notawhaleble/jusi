...
python -m build
python scripts/check-distribution.py dist/jusi-1.0.0rc2-py3-none-any.whl
```
...
```sh
JUSI_DISTRIBUTION_WHEEL=dist/jusi-1.0.0rc2-py3-none-any.whl python -m pytest -q tests/packaging
```
